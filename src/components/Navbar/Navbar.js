...
const Navbar = () => {
  return (
    <div className='Nav-container'>
        ...
        <div className='logo'>
            <img src="https://b.zmtcdn.com/web_assets/b40b97e677bc7b2ca77c58c61db266fe1603954218.png" className='Logo-container' alt="logo" />
        </div>
        ...
        <div className='Search-container'>
            ...
            <form>
            <input type="text" id="location-input" class="search-input" placeholder="Enter a location"/>
            ...
            <input type="text" id="location-input" class="search-input" placeholder="Search Restaurants"/>
            </div>
